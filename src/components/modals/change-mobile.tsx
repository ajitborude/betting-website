      ...
      <Dialog as="div" className="relative z-20" onClose={() => { }} open={isOpened}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex items-center justify-center min-h-full p-4 text-center ">
            ...
            >
              <Dialog.Panel className="relative flex flex-col justify-center w-full max-w-lg pt-8 pb-10 pl-8 pr-10 edit-username-frame">
                <div className='flex self-end'>
                  <label className='pr-4 text-2xl text-right heading typing-change-password'>Edit Mobile Number</label>
                </div>
                <Transition
                ...
                >
                  <div className='w-full px-4 mt-5'>
                    <TextInput
                      isPassword={false}
                      validator={[validator, 'required|numeric|min:10|max:10']}
                      defaultValue={phone}
                ...
                <Transition
                  ...
                  enterTo="opacity-100"
                >
                  <div className='absolute -bottom-2.5 right-1 w-20 h-20 cursor-pointer rotate-3 rounded-full z-20' onClick={handleDecline}>
                    <CloseButton />
                  </div>
                </Transition>
              </Dialog.Panel>
