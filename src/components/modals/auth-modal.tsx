        ...
        <Dialog as="div" className="relative z-[999]" onClose={() => {}}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex items-center justify-center min-h-full p-4 text-center ">
              ...
              >
                {isLoading ? (
                  <Dialog.Panel className="grid w-[90%] max-w-3xl grid-cols-2 overflow-hidden transition-all transform bg-white shadow-xl rounded-2xl h"></Dialog.Panel>
                ) : (
                  <Dialog.Panel className="grid w-[90%] max-w-3xl grid-cols-2 overflow-hidden transition-all transform bg-white shadow-xl rounded-2xl h">
                    ...
                    <div className="bg-[#111823]">
                      <div className="flex justify-end w-full p-2">
                        <div
                          className="btn btn-circle bg-[#111823]"
                      ...
                      <div className="flex justify-start w-full px-8">
                        <div
                          className={`mr-2 btn  ${
                            isLoginPage ? "btn-primary" : "btn-ghost"
                          }`}
                      ...
                      {isLoginPage ? (
                        <div className="flex flex-col items-start justify-center w-full px-8">
                          <Link href="/forgot-password">
                            <a className="text-xs text-blue-400 underline underline-offset-4">
                              Forgot Password?
                            </a>
                          </Link>
                          <div
                            className="w-full my-6 btn btn-primary"
                            onClick={() => handleLogin()}
                          >
                            Login
                          </div>
                          <label className="mb-4 text-xs text-[#506179] font-medium w-full">
                            or Login with
                          </label>
                          ...
                          <label className="text-xs text-[#506179] my-4">
                            By accessing the site, I confirm that I am 18 years
                            old and I have read the{" "}
                            <Link href="/tnc">
                              <a className="text-xs text-blue-400 underline underline-offset-4">
                                terms of service
                              </a>
                          ...
                          <label className="my-4 text-xs text-white">
                            Don&apos;t you have an account{" "}
                            <label
                              className="text-xs text-blue-400 underline cursor-pointer underline-offset-4"
                              onClick={() => setIsLoginPage(false)}
                            >
                              Sign Up
                            </label>
                        ...
                        <div className="flex flex-col items-start justify-center w-full px-8">
                          <div className="flex flex-row items-start my-2">
                            ...
                            <label className="text-xs text-[#506179] ml-1">
                              By accessing the site, I confirm that I am 18
                              years old and I have read the{" "}
                              <Link href="/tnc">
                                <a className="text-xs text-blue-400 underline underline-offset-4">
                                  terms of service
                                </a>
