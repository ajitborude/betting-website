...
const TabButton: React.FC<Props> = ({ text, selected, type }) => {
  let classes = {
    left: '',
    center: '',
    right: '',
  ...
  switch (type) {
    case 'start':
      if (selected) classes = { left: 'tab-odd-left', center: 'tab-odd-center', right: 'tab-odd-right', extra: 'tab-start' };
      else classes = { left: 'tab-odd-left-inc', center: 'tab-odd-center-inc', right: 'tab-odd-right-inc', extra: 'tab-start' };
      break;
    case 'even':
    ...
    case 'odd':
      ...
      break;
    case 'end-even':
      if (selected) classes = { left: 'tab-even-left', center: 'tab-even-center', right: 'tab-even-right', extra: 'tab-end-even' };
      else classes = { left: 'tab-even-left-inc', center: 'tab-even-center-inc', right: 'tab-even-right-inc', extra: 'tab-end-even' };
      break;
    case 'end-odd':
