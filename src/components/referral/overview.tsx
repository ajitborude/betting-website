...
const referralLink = "https://betting.inc/bike/approval?beds=battle&blood=bell";
    ...
    <div className="flex flex-col w-full h-full">
      ...
      >
        <div className="flex flex-col w-full overview-frame">
          <div className="flex flex-col w-full px-4 pt-3">
            <label className="w-full mb-4 text-right heading !text-title-500 text-xl ">
              My Statistics
            </label>
            <div className="flex flex-col items-center justify-between mb-6 md:flex-row">
              <div className="flex flex-col items-start justify-center w-full py-6 md:py-0 md:items-center md:w-1/5">
                ...
                <label className="heading !text-special-500 text-sm">
                  Referrals
                </label>
              </div>
            ...
            <div className="flex flex-row items-start justify-start w-full px-4 border-r md:w-[60%] border-r-special-400 border-opacity-20">
              ...
              >
                <div className="flex flex-col w-[70%]">
                  <label className="w-full my-2 font-bold text-left">
                    My Referral Link
                  </label>
                  <div className="flex flex-row items-center justify-between w-full py-2 input-bg">
                    ...
                    <div
                      className="px-4 mx-2 text-sm btn btn-ghost btn-sm heading"
                      onClick={() => {
              ...
              <div className="flex flex-col items-center justify-center w-[40%] px-12 2xl:px-18 py-2 ">
                ...
                <SecondaryButton onClick={() => {}}>
                  <div className="flex flex-row items-center justify-center">
                    <Icon source="dropbox" />
                    <label className="pb-2 text-sm truncate heading">
      ...
      >
        <label className="w-full px-2 my-6 text-justify">
          ...
          volutpat quam vitae viverra. Pellentesque facilisis feugiat mauris, eu
          mollis orci dapibus in. Phasellus in pharetra metus. Etiam mattis,
          nulla sed lacinia bibendum, magna libero convallis mi, vitae porttitor
          nulla libero nec quam. Donec sit amet turpis iaculis, ultricies urna
          sed, elementum libero. Aenean ut nisi non nisi pulvinar placerat.
          Donec leo diam, efficitur id condimentum at, tincidunt id lectus.
        </label>
      </Transition>
      <Transition
        show={isShowing}
            ...
            <div className="relative flex items-center justify-center w-full mx-4 md:w-1/3">
              ...
              <div className=" referral-hex-text-container">
                ...
                <label className="referral-hex-text-4">
                  of the rake generated by the referee on the winning bet.
                </label>
              </div>
            </div>
            <div className="relative flex items-center justify-center w-full mx-4 md:w-1/3 ">
        ...
        <div className="flex flex-row items-center justify-center w-full py-10 mt-10 overview-strip mb-52">
          <div className="w-1/2 pr-10">
            <label className="w-full text-justify ">
              ...
              fermentum volutpat quam vitae viverra. Pellentesque facilisis
              feugiat mauris, eu mollis orci dapibus in. Phasellus in pharetra
              metus. Etiam mattis, nulla sed lacinia bibendum, magna libero
              convallis mi, vitae porttitor nulla libero nec quam. Donec sit
              amet turpis iaculis, ultricies urna sed, elementum libero. Aenean
              ut nisi non nisi pulvinar placerat. Donec leo diam, efficitur id
              condimentum at, tincidunt id lectus. Lorem ipsum dolor sit amet,
              consectetur adipiscing elit. In fermentum volutpat quam vitae
              viverra.
            </label>
          </div>
