...
const ReferralTabs = dynamic(() => import('@/components/referral/referral-tabs'), { loading: () => <div /> });
...
const ReferralPage: NextPage<PageProps> = (_props) => {
